 ...
 */
public class HealthCheckRegistrySet
                implements MetricSet
{
    private static final Logger logger = LoggerFactory.getLogger( HealthCheckRegistrySet.class );

    private String name = "healthcheck";

    private HealthCheckRegistry healthCheckRegistry;

    public HealthCheckRegistrySet()
    {
